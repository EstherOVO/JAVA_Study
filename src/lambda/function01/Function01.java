...
//      매개변수가 없고, 리턴 값이 없음(java.lang 패키지)
        Runnable runnable;

//      매개변수가 1개 <T>가 있고, 리턴 값이 없음
        Consumer<Integer> consumer;
//      매개변수가 2개 <T, U> 있고, 리턴 값이 없음
        BiConsumer<Integer, Integer> biConsumer;

//      매개 변수는 없고, 리턴 값이 있음
        Supplier<Integer> supplier;

//      매개변수 1개 <T>가 있고, 리턴 값<R>도 있음
        Function<Integer, String> function;
//      매개변수 2개 <T, U>가 있고, 리턴 <R> 값도 있음
        BiFunction<Integer, Integer, Integer> biFunction;

//      매개변수가 1개 <T>가 있고, 리턴 값이 Boolean → 판별식
        Predicate<Integer> predicate;
//      매개변수가 2개<T, U> 있고, 리턴 값이 Boolean
        BiPredicate<Integer, Integer> biPredicate;

//      매개변수의 타입과 리턴 타입이 독같은 형태의 Function Operator
