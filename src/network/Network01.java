...
//          IP 주소의 정보를 바이트 배열 또는 문자열로 반환
            ...
            System.out.println("address = " + Arrays.toString(address));    // byte ← IP
            System.out.println("hostName = " + hostName);
            System.out.println("hostAddress = " + hostAddress);

//          도메인 주소로 IP 주소 객체 반환
            InetAddress duamIp = InetAddress.getByName("www.duam.net");
            System.out.println("다음 호스트 이름 = " + duamIp.getHostName());
            System.out.println("다음 IP = " + duamIp.getHostAddress());
...
//      IP 주소가 할당된 호스트 정보 조회
        ...
        printAllIPs(hostName);
    }

    static void printAllIPs(String hostName) {
