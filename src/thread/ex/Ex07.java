 ...
 */
        ...
        List<CoffeeOrder> coffeeList = new ArrayList<>(Arrays.asList(
                new CoffeeOrder("에스프레소", 2),
                new CoffeeOrder("아메리카노", 3),
                new CoffeeOrder("카푸치노", 5),
                new CoffeeOrder("라떼", 4),
        ...
        coffeeList.forEach(coffee -> {
            executorService.execute(() -> {
                ...
                System.out.println(String.format("[%s] %s 준비 시작-", Thread.currentThread().getName(), coffee.menu));
                ...
                System.out.println(String.format("[%s] %s %d개 : 준비 완료!", Thread.currentThread().getName(), coffee.menu, coffee.quantity));
            });
        });
