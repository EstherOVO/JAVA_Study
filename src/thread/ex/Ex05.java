...
*/
        ...
        Thread thread1 = new Thread(new MyDual("마법사 A", "불", 1000));
        Thread thread2 = new Thread(new MyDual("마법사 B", "얼음", 1500));
        ...
        System.out.println("모든 듀얼이 종료되었습니다.");
    }

    public static class MyDual implements Runnable {

        String name;
        String skill;
        long interval;

        public MyDual(String name, String skill, long interval) {
            this.name = name;
            this.skill = skill;
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("마법 사용이 중단되었습니다.");
            }
        }
    }
}
