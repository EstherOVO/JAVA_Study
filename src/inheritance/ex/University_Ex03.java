...
public class University_Ex03 {
    public static void main(String[] args) {

/*
        대학 관리 시스템 구현
        대학에서 교수(Professor)와 학생(Student)을 관리하는 시스템을 구축합니다.
        Person 클래스를 상속받아 Professor와 Student 클래스를 구현하되, 각각의 특성에 맞는 추가 속성과 메소드를 포함시킵니다.
