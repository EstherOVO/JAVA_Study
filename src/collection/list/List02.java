...
//      Collection 타입의 매개변수를 넣는 곳에 넣을 수 있다.
...
//      fruits4.add("밤");   변경 가능한 메서드를 넣었을 때 : UnsupportedOperationException

//      mutable List에 immutable List를 넣었을 때 → mutable
        fruits1.addAll(fruits4);
        System.out.println("fruits1 = " + fruits1);

//      리스트의 지정된 범위만큼을 반환(시작 인덱스 포함, 끝 인덱스 포함하지 않음)
...
//      indexOf() : 객체로 인덱스를 반환한다. 가장 첫 번째 인덱스를 찾고 없으면 -1을 반환한다.
...
//      sort() : 요소를 정렬 Comparator(정렬자)를 매개변수로 받는다.
