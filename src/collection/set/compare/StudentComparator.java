...
//  중첩 클래스
    ...
    public enum SortDirection { ASC, DESC } // 정렬 순서(오름차순, 내림차순)
...
//      삼항 연산자로 표현할 경우!
//      return (sortDirection == StudentComparator2.SortDirection.ASC ? compareResult : compareResult * -1);
    }
}
