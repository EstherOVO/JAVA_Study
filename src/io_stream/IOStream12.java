...
//  객체를 직렬화하기 위해서는 Serializable을 구현해야 한다.
...
//      여러 개의 객체를 저장할 때는 출력된 순서와 동일하게 읽어와야 가능하다.
        ...
        System.out.println("member22 = " + member22);
        System.out.println("memberArr = " + Arrays.toString(memberArr));
    }
}
