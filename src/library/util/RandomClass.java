...
//      java.util 패키지
//      (java.lang 패키지를 제외한 모든 패키지는 import해야 사용할 수 있다.)
//      컬렉션 프레임워크를 활용한 여러 가지 유용한 클래스들을 포함하고 있다.
...
//      시드 값 : 난수 생성의 시작점을 제공하고, 동일한 시드값을 생성된 Random 갹체는
//      동일한 난수를 생성
...
//      시드 값을 설정하지 않을 때 : System.currentTimeMillis(); 또는 유사한 시간 기반 값의 시드를 자동으로 설정한다.
//      → 완전한 무작위성과 보안을 보장하지 않는다.
//      보안이 중요한 상황에서는 SecureRandom 등과 같은 노이즈 값이 포함된 다른 클래스를 사용한다.
